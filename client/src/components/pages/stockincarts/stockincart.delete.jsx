...
const StockincartDelete = ({ selectedRow, handleCancel, handleSubmit}) => {
    return (
        <div className="flex justify-center items-center py-5 gap-5">
            ...
            <div className="text-gray-700 text-center text-sm">
                ...
                <p className="py-3">{`${selectedRow.product.description} (${selectedRow.stockinNumber})`}</p>
...
export default StockincartDelete
