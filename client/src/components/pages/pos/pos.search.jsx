...
const PosSearch = ({ resultProducts, handleSelectProduct }) => {
    return (
                ...
                <tbody>
                    {resultProducts.length === 0 ? (
                        <tr>
                            ...
                            <tr className="w-full">
                                <td colSpan="2" className="flex flex-col items-center gap-3">
                                    <tr><td colSpan="2" className="text-center text-sm font-semibold text-gray-600">SELECT PRODUCT</td></tr>
                                                ...
                                                <td className="px-5 bg-white">
                                                    <div className="flex items-center">
                                                        <div className="flex gap-2 py-2 text-sm text-gray-700 whitespace-no-wrap">
                                                            ...
                                                            <div className="w-40">₱ {helper.formatNumber(product.price)} / {product.unit}</div>
                                                            <div className="">{ product.quantity > 0 ? `${product.quantity} ${product.unit} left` : null}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-5 bg-white">
                                                    <div className="flex items-center">
                                                        <div className="py-2 whitespace-no-wrap">
                                                            {product.quantity > 0 ? <button 
                                                                    ...
                                                                    className="px-2 py-1 bg-gray-400 hover:bg-gray-500 text-xs text-white uppercase"
                                                                >
                                                                    Select
                                                                </button>:
                                                                <span className="text-red-500 text-xs uppercase">no stock</span>
                                                            }
                                                        </div>
                                                    </div>
                                                </td>
